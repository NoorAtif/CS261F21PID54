...
class Ui_Dialog(object):
        def loaddata(self):
                ...
                with open(r"C:/Users/Amiga/Desktop/Mid Project/CS261F21PID54/products.csv", mode ='r')as file:
                        csvFile = csv.reader(file)

                        for lines in csvFile:
                                Description.append(lines[0])
                                Price.append(lines[1])
                                Review.append(lines[2])
                                Size.append(lines[3])
                                Rating.append(lines[4])
                                SizeDiscount.append(lines[5])
                                PriceBeforeDiscount.append(lines[6])
                        


                row=0
                self.tableWidget.setRowCount(len(Description))
                for des in Description:
                        self.tableWidget.setItem(row, 0, QtWidgets.QTableWidgetItem(des))
                        row=row+1
                row=0
                for pr in Price:
                        self.tableWidget.setItem(row, 1, QtWidgets.QTableWidgetItem(pr))
                        row=row+1
                row=0
                for Re in Review:
                        self.tableWidget.setItem(row, 2, QtWidgets.QTableWidgetItem(Re))
                        row=row+1
                row=0
                for Se in Size:
                        self.tableWidget.setItem(row, 3, QtWidgets.QTableWidgetItem(Se))
                        row=row+1
                row=0
                for Ra in Rating:
                        self.tableWidget.setItem(row, 4, QtWidgets.QTableWidgetItem(Ra))
                        row=row+1
                row=0
                for SZ in SizeDiscount:
                        self.tableWidget.setItem(row, 5, QtWidgets.QTableWidgetItem(SZ))
                        row=row+1
                row=0
                for PF in PriceBeforeDiscount:
                        self.tableWidget.setItem(row, 6, QtWidgets.QTableWidgetItem(PF))
                        row=row+1
